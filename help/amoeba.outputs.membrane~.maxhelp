{
  "patcher": {
    ...
    "boxes": [
      { "box": { "id": "title", "maxclass": "comment", "text": "Amoeba Outputs Membrane — elastic multichannel body", "fontsize": 18.0, "patching_rect": [30.0, 15.0, 720.0, 26.0] } },
      { "box": { "id": "source", "maxclass": "newobj", "text": "cycle~ 220", "patching_rect": [30.0, 52.0, 70.0, 22.0] } },
      { "box": { "id": "event", "maxclass": "message", "text": "55 127 500 3", "patching_rect": [118.0, 52.0, 100.0, 22.0] } },
      { "box": { "id": "module", "maxclass": "newobj", "text": "amoeba.outputs.membrane~ @outputs 6", "patching_rect": [30.0, 90.0, 1040.0, 720.0] } },
      ...
      { "box": { "id": "speaker", "maxclass": "message", "text": "speaker 5 -135. 1. 40.", "patching_rect": [1100.0, 145.0, 148.0, 22.0] } },
      { "box": { "id": "character", "maxclass": "message", "text": "character rupture", "patching_rect": [1100.0, 185.0, 114.0, 22.0] } },
      { "box": { "id": "param", "maxclass": "message", "text": "set elevation 0.76", "patching_rect": [1100.0, 225.0, 126.0, 22.0] } },
      { "box": { "id": "info", "maxclass": "comment", "text": "Seven points describe an elastic spatial membrane. Audio events create waves that stretch the body across the speaker geometry; velocity controls impact energy while elevation allows surface motion above and below the listener plane.", "linecount": 7, "patching_rect": [1100.0, 285.0, 330.0, 120.0] } }
    ],
    "lines": [
